...
int main(int argc, char** args)
{
    ...
    SDL_Log("Press LMB or W to show the image");
    while (loop()) {
    ...
    while (SDL_PollEvent(&e) != 0) {
        ...
        case SDL_MOUSEBUTTONDOWN:
            ...
            case SDL_BUTTON_LEFT:
                SDL_Log("SDL_MOUSEBUTTONDOWN SDL_BUTTON_LEFT");
                renderImage2 = true;
                break;
        ...
        case SDL_MOUSEBUTTONUP:
            switch (e.button.button) {
            case SDL_BUTTON_LEFT:
                SDL_Log("SDL_MOUSEBUTTONUP SDL_BUTTON_LEFT");
                renderImage2 = false;
                break;
            case SDL_BUTTON_RIGHT:
                break;
